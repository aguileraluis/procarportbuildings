...
{clicked ?
  <Filter>
    <FilterTitle>Standard Heights 6'-16' : {sideheight}</FilterTitle>
    <></>
  </Filter>
  :
  <Filter>
...
//                 <button onClick={() => addTotal(1695)} className="btn">20' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(2095)} className="btn">25' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(2495)} className="btn">30' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(2895)} className="btn">35' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(3395)} className="btn">40' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(3790)} className="btn">45' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(4190)} className="btn">50' LONG</button>
//               </li>
//             </ul>
//           </li>
//           <li>
...
//             <ul className="sub-menu" >
//               <li className="listitem">
//                 <button onClick={() => addTotal(1795)} className="btn">20' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(2195)} className="btn">25' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(2695)} className="btn">30' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(3095)} className="btn">35' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(3595)} className="btn">40' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(3990)} className="btn">45' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(4390)} className="btn">50' LONG</button>
//               </li>
//             </ul>
//           </li>
//           <li>
...
//             <ul className="sub-menu" >
//               <li className="listitem">
//                 <button onClick={() => addTotal(1995)} className="btn">20' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(2495)} className="btn">25' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(3095)} className="btn">30' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(3595)} className="btn">35' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(4095)} className="btn">40' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(4490)} className="btn">45' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(4990)} className="btn">50' LONG</button>
//               </li>
//             </ul>
//           </li>
//           <li>
...
//             <ul className="sub-menu" >
//               <li className="listitem">
//                 <button onClick={() => addTotal(2395)} className="btn">20' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(2995)} className="btn">25' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(3595)} className="btn">30' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(4195)} className="btn">35' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(4795)} className="btn">40' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(5390)} className="btn">45' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(5990)} className="btn">50' LONG</button>
//               </li>
//             </ul>
//           </li>
//           <li>
...
//             <ul className="sub-menu" >
//               <li className="listitem">
//                 <button onClick={() => addTotal(2495)} className="btn">20' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(3095)} className="btn">25' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(3795)} className="btn">30' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(4395)} className="btn">35' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(4995)} className="btn">40' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(5590)} className="btn">45' LONG</button>
//               </li>
//               <li className="listitem">
//                 <button onClick={() => addTotal(6190)} className="btn">50' LONG</button>
//               </li>
//             </ul>
//           </li>
//         </ul>

    ...
    return (
        <div className='about' id='about'>
            <div className='container'>
                <img className="aboutimg" src='https://i.postimg.cc/SxFZ1pYv/LOGO.jpg' alt='john' data-aos="flip-right"/>
                <div className='col-2'>
                    ...
                    <p data-aos="flip-right">With over 25 years of experience behind our team, you are guaranteed the best service.</p>
